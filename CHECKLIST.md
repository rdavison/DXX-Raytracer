# Metal Backend Skeleton — Implementation Checklist

---

## Step 1: Platform Portability — RT/Core

### 1.1 `RT/Core/VirtualMemory.c` — Add POSIX implementation
...
### 1.2 `RT/Core/Common.c` — Add macOS implementation
- [ ] Wrap existing Windows code in `#ifdef _WIN32`
...
### 1.3 `RT/Renderer/Backend/Common/include/ApiTypes.h` — Cross-platform macros
...
### 2.1 `sdl-master/sdl/SDL_syswm.h` — Add Quartz SysWMinfo
...
### 2.2 SDL Quartz WM implementation — Populate nswindow
...
### 2.3 `sdl-master/sdl/SDL_config_macosx.h` — Fix driver priority
...
### 3.1 Root `CMakeLists.txt` — Add Metal recognition
...
### 3.2 `CMakePresets.json` — Add Metal presets
...
### 3.3 `RT/CMakeLists.txt` — Conditional backend selection
...
### 3.4 `d1/CMakeLists.txt` — Add Metal source files and link libs
...
### 3.5 Create `RT/Renderer/Backend/Metal/CMakeLists.txt`
...
### 4.2 Copy third-party libraries from DX12 (full copies)
...
### 4.3 Copy platform-independent source files from DX12
...
### 4.4 Create `RT/Renderer/Backend/Metal/src/MetalIncludes.h`
- [ ] Add `#pragma once`
...
### 4.5 Create `RT/Renderer/Backend/Metal/src/GlobalMetal.h`
- [ ] Add `#pragma once`
...
### 4.6 Create `RT/Renderer/Backend/Metal/src/RenderBackend.h`
- [ ] Add `#pragma once`
...
### 4.7 Create `RT/Renderer/Backend/Metal/src/RenderBackend.mm`
...
### 4.8 Create `RT/Renderer/Backend/Metal/src/Renderer.mm`
...
### 5.3 Modify `RT/RTgr.c` — Add RT_METAL guards
...
### 5.4 Modify `RT/RTgr.h` — Conditional cimgui include
...
### 5.5 Modify `d1/include/gr.h` — Add RT_METAL to bitmap struct
