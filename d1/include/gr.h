...
#define BM_SVGA15   4
#if defined(OGL) || (defined(RT_DX12) || defined(RT_METAL)) || defined(RT_METAL)
#define BM_OGL      5
#define BM_RGBA8    6
#endif /* def OGL */
...
#if (defined(RT_DX12) || defined(RT_METAL)) || defined(RT_METAL)
...
//		if (iff_error != IFF_NO_ERROR) RT_LOGF(RT_LOGSERVERITY_HIGH, "Can't load IFF file <%s>, error=%d",filename,iff_error);
